...
INSERT INTO Installations (installationLead, installationDate, installationInstructions)
VALUES 
	('iL1', 2020-11-11, 'use back enterance'),
	('iL2', 2020-11-28, 'call one hour before installation'),
	('iL3', 2020-12-20, 'install half in room 204 and half in 205'),
	('iL4', 2020-12-30, 'use back enterance'),
	('iL5', 2021-02-11, 'elevator requires key card, call reception on floor 8 to have someone let you up'),
	('iL6', 2021-02-15, 'use back enterance'),
	('iL7', 2021-02-28, 'call one hour before installation'),
	('iL8', 2021-04-01, 'use back enterance'),
	('iL9', 2021-04-10, 'install half on floor 2 and half on floor 3'),
	('iL10', 2021-05-03, 'use back enterance'),
	('iL11', 2021-06-11, 'elevator requires key card, call reception on floor 6 to have someone let you up'),
	('iL12', 2021-07-16, 'call one hour before installation'),
	('iL13', 2021-07-19, 'install half in office 7 and half in office 12'),
	('iL14', 2021-08-02, 'use back enterance'),
	('iL15', 2021-08-12, 'call one hour before installation');
